...
6. [Formatters](06_FORMAT.md) documents diagram generation (PlantUML, Mermaid, Graphviz, SCXML, XState).
...
- Lifecycle hooks
- Mermaid, PlantUML, SCXML, XState, and Graphviz output (see [Formatters](06_FORMAT.md))
